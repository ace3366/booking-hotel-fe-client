...
const SearchListItem = ({
  ...
  return (
    <>
      <div className="flex md:flex-row flex-col  justify-between gap-x-3 mb-6 p-3 border-2 border-slate-300 rounded">
        <div className="flex gap-2">
          ...
          <div className="flex-initial justify-between">
            <Link
              to={`/detail/${id}`}
        ...
        <div className="flex-initial flex flex-col justify-between">
          <div className=" flex justify-end">
            <span className=" font-bold p-2 text-white bg-[#003580]">
              {rate}
            </span>
          </div>
          <div className="flex md:flex-col gap-2 justify-between mt-3 flex-row">
